...
class Reservation(models.Model):
    ...
    confirmations = models.ManyToManyField(CustomUser, related_name="confirmed_users", blank=True)
...
class Repair(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.picture:
            ...
            pass
        if not self.slug:
            self.slug = slugify('repair_bill' + '_' + self.car.name + '_' + str(self.paid_day))
